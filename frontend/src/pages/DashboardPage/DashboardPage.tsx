    ...
    <div className={styles.dashboard}>
      <div className={styles.dashboardContainer}>
        ...
        <div className={styles.dashboardActions}>
          {user.role === "teacher" ? (
            <>
              <Button to="/tasks/create" variant="gradient" icon={Plus} viewTransition>
                Создать новую задачу
              </Button>
              <Button to="/tasks" variant="outline" icon={List} viewTransition>
                Управление задачами
              </Button>
              <Button to="/submissions" variant="secondary" icon={Users} viewTransition>
                Проверка ответов
              </Button>
            </>
          ) : (
            <>
              ...
              <Button to="/profile" variant="outline" icon={User} viewTransition>
                Мой Профиль
              </Button>
              <Button
        ...
        {user.role === "student" && (
          <QuickStats
            items={[
              { label: "Доступных заданий", value: 8, icon: List },
            ]}
          />
        )}
        ...
        <main className={styles.dashboardContent}>
          <div className={styles.dashboardSection} ref={progressRef}>
            <div className={styles.dashboardSectionHeader}>
              ...
              <Link to="/analytics" className={styles.dashboardSectionAction} viewTransition>
                Посмотреть детали
              </Link>
            </div>
        ...
        <div className={styles.dashboardSection} style={{ marginTop: "2rem" }}>
          <div className={styles.dashboardSectionHeader}>
            <h2 className={styles.dashboardSectionTitle}>
              <CheckCircle className={styles.dashboardSectionTitleIcon} />
              Quick Help & Tips
            </h2>
