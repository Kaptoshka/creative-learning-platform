        ...
        return (
            <div className={styles.submissionsPage}>
                <div className={styles.submissionsPageContainer}>
                    <Loader fullPage variant="bar" label="Загрузка ответов…" />
                </div>
            </div>
        );
    }
                ...
                <div className={styles.controls}>
                    <div className={styles.controlsFilters}>
                        ...
                        <Button
                            ...
                            className={`${styles.controlsFilterBtn} ${
                                filter === "urgent"
                                    ? styles.controlsFilterBtnActive
                                    : ""
                            }`}
                        >
                            Давно отправлены
                        ...
                        {filteredSubmissions.map((submission) => (
                            ...
                            >
                                ...
                                <div className={styles.submissionCardHeader}>
                                    <div
                                        className={styles.submissionCardStudent}
                                    >
                                        <div
                                            className={
                                                styles.submissionCardAvatar
                                            }
                                        >
                                        ...
                                        <div
                                            className={
                                                styles.submissionCardStudentInfo
                                            }
                                        >
                                            <div
                                                className={
                                                    styles.submissionCardStudentName
                                                }
                                            >
                                            ...
                                            <div
                                                className={
                                                    styles.submissionCardStudentEmail
                                                }
                                            >
                                ...
                                <div className={styles.submissionCardBody}>
                                    <div className={styles.submissionCardTask}>
                                        <h3
                                            className={
                                                styles.submissionCardTaskTitle
                                            }
                                        >
